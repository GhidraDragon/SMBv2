...
import socket
import ssl
import threading  # <-- Added for running background thread
...
# Background thread function to run if SMBv2 not detected
    ...
    while q:
        ...
        if host_ip:
            ...
            if smb_result:
                ...
                run_background_thread(host_ip)  # <-- Run background thread if SMBv2 not detected
